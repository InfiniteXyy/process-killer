...
export function TaskItem(props: { task: ITask }) {
  const { task } = props;
  return (
    <div className="mr-2 flex items-center justify-between gap-2 rounded-lg p-2 hover:bg-neutral-200 dark:hover:bg-neutral-900">
      <div className="flex space-x-2 overflow-hidden font-medium">
        <div className="h-6 w-6 flex-shrink-0 rounded-lg bg-gray-300" />
